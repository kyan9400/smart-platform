...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why" className="py-16 bg-saudi-800 text-white relative overflow-hidden border-y border-emerald-600/20">
      <div
      ...
      />
      <div className="pointer-events-none absolute -top-24 end-0 h-96 w-96 rounded-full bg-emerald-400/15 blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-start">
            ...
            <p className="text-emerald-100 text-base leading-relaxed mb-7">{t.why.intro}</p>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {t.why.reasons.map((reason) => (
                <li key={reason} className="flex items-start gap-2 text-sm text-emerald-50/95">
